...
import com.vanskarner.adapters.common.BasicEndlessAdapterOther;

import java.util.List;

public class MoviesNew extends BasicEndlessAdapterOther<MovieModel, MoviesNew.ItemClickViewHolder> {
